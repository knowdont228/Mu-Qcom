# @file
# Script to Build Mi 10T/Pro UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("apolloPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('apollo', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "apolloPkg/apollo.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "apollo", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "apolloPkg/apollo.dsc", "Platform Hardcoded")
